...
alias ..="cd .."
alias b="cd -"
alias listening_local_interfaces_tcp_udp="sudo ss -tlnp"
alias idp="ps -fp \$1"
alias ls_active_tcp_connexion="sudo ss -tnp"
alias ls_active_udp_connexion="sudo ss -tunp"
alias ls_bind_permanent_socket_port_tcp="sudo ss -tnlp"
